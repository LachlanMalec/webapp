        ...
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img
              ...
              src="https://lachlanmalec.dev/logo.png"
              alt=""
            />
          </a>
        </div>
              ...
              <div className="space-y-2 py-6">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 dark:text-gray-100 text-gray-900 dark:hover:bg-slate-900 hover:bg-gray-50"
                  >
                    {item.name}
                  </a>
                ))}
