    ...
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-fg"
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-bg_h px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-fg/10">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              className="-m-2.5 rounded-md p-2.5 text-fg"
